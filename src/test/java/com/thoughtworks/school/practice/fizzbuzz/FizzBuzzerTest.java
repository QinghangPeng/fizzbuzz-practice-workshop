...
class FizzBuzzerTest {
  ...
  @Test
  void should_return_fizz_when_it_contains_3_and_is_multiple_of_3() {
    assertEquals("Fizz", fizzBuzzer.fizzBuzz(33));
  }

  @Test
  void should_return_fizz_when_it_contains_3_and_is_multiple_of_5() {
    assertEquals("Fizz", fizzBuzzer.fizzBuzz(30));
  }

  @Test
  void should_return_fizz_when_it_contains_3_and_is_multiple_of_7() {
    assertEquals("Fizz", fizzBuzzer.fizzBuzz(63));
  }

  @Test
  void should_return_buzz_whizz_when_it_contains_5_and_3_and_is_multiple_of_5_and_7() {
    assertEquals("BuzzWhizz", fizzBuzzer.fizzBuzz(35));
  }

  @Test
  void should_return_buzz_when_it_contains_5_and_is_multiple_of_3() {
    assertEquals("Buzz", fizzBuzzer.fizzBuzz(15));
  }

  @Test
  void should_return_fizz_whizz_when_contains_7_and_3_and_5_and_is_multiple_of_3_and_5_and_7() {
    assertEquals("FizzWhizz", fizzBuzzer.fizzBuzz(735));
  }
}